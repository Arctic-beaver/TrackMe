# TrackMe — карта экранов и wireframes Этапа 0
...
```mermaid
flowchart LR
    Launch["Запуск TrackMe"] --> Today["Today"]
    ...
    Utility["Служебное меню"] --> Appearance["Темы и язык"]
...
В `Темы и язык` доступны `System`, `Русский`, `English` и `Español`. Смена языка
применяется на текущем экране без перезапуска и без сброса выбранной темы,
фильтров или открытой карточки.
...
```text
┌─────────────────────────────────────────────────────────────────────────────┐
│ TrackMe · Agile your life                                  [+ Создать]      │
│          [Сегодня]   [Неделя]   [Месяц]   [Проекты]                        │
├─────────────────────────────────────────────────────────────────────────────┤
│ Добрый день                        четверг, 23 июля                         │
│ Сегодня важно продвинуть главное.  [Все проекты ▾] [Все теги ▾]            │
├────────────────┬──────────────────┬──────────────────┬─────────────────────┤
│ Входящие       │ На сегодня       │ В процессе       │ Готово              │
│ когда будет    │ выбрано на       │ двигается сейчас │ можно выдохнуть     │
│ время          │ сегодня          │                  │                     │
│                │                  │                  │                     │
...
```text
┌─────────────────────────────────────────────────────────────────────────────┐
│ TrackMe · Agile your life                            [+ Новый проект]       │
│ [Сегодня] [Неделя] [Месяц] [Проекты]                                      │
├─────────────────────────────────────────────────────────────────────────────┤
│ Проекты                                                                     │
...
```text
┌─────────────────────────────────────────────────────────────────────────────┐
│ TrackMe · Agile your life                                  [+ Задача]       │
│ [Сегодня] [Неделя] [Месяц] [Проекты]                                      │
├─────────────────────────────────────────────────────────────────────────────┤
...
│                                                                             │
│ Прогресс 3 из 10                                                           │
│ Задачи: Входящие · На сегодня · В процессе · Готово                        │
